...
class SegmentsRepository {
  ...
  static Future<void> readSegmentData() async {
    ...
    final jsonPath = '${await SaveLocationsPaths.getReaderTimingDataLocationUrl()}${reader.identifier}.json';
  ...
  static Future<int?> getCurrentSegmentWord({required int surahId, required verseID, required currentPosition}) async {
    List<List<int>> currentVerseSegmet = segmentsList
        .firstWhere((element) => element.surah == surahId && element.ayah == verseID,
